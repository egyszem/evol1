...
def route():
    x, y = w2, h2
    for p in range(0, route_length):
        r = random.randint(0, 3)
        u, v = x + a[r], y + b[r]
        color = int(255 * (1 - p / route_length ))
        draw.line(((x, y, u, v)), fill=color, width=int((route_length - p) / 100), joint="curved")
        x, y = u, v
...
#evaluate()
im.show()
im.save("randutas1 side 20 length 1000 count 1.jpg")
